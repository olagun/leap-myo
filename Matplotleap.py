...
def plot_bone_lines(points, ax):
    ...
    # line = plt3d.art3d.Line3D(
    #     [wrist[0], mcps[4][0]], [wrist[1], mcps[3 + 1][1]], [wrist[2], mcps[3 + 1][2]]
    # )
    # ax.add_line(line)

    # # Generate the "Wrist", note right side is not right.
    # line = plt3d.art3d.Line3D(
    #     [wrist[0], mcps[0][0]], [wrist[1], mcps[0][1]], [wrist[2], mcps[0][2]]
    # )
    # ax.add_line(line)
...
def get_bone_points(hand):
    ...
    # Add wrist position
    # X.append(-1 * hand.wrist.position.x)
    # Y.append(hand.wrist.position.y)
    # Z.append(hand.wrist.position.z)
