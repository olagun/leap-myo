            ...
            for index_digit in range(0, 5):
                ...
                for index_bone in range(0, 4):
                    ...
                    if self.hands_format == "Dots":
                        ...
                        if prev_joint:
                            cv2.circle(
                                self.output_image, prev_joint, 2, self.hands_colour, -1
                            )

                        if next_joint:
                            cv2.circle(
                                self.output_image, next_joint, 2, self.hands_colour, -1
                            )
                    ...
                    if self.hands_format == "Skeleton":
                        ...
                        if wrist:
                            cv2.circle(
                                self.output_image, wrist, 3, self.hands_colour, -1
                            )

                        if elbow:
                            cv2.circle(
                                self.output_image, elbow, 3, self.hands_colour, -1
                            )

                        if wrist and elbow:
                            cv2.line(
                                self.output_image, wrist, elbow, self.hands_colour, 2
                            )
                        ...
                        if ((index_digit == 0) and (index_bone == 0)) or (
                            ...
                            bone_next_start = self.get_joint_position(
